...
\begin{SCn}
  ...
  \scntext{note}{names of sections differ in table of contents depth, but in the text of \textit{PDF} they all are called "Section"}
  ...
  \begin{scnhaselementset}
    ...
    \begin{scnindent}
      \scntext{purpose}{this macros creates construction equivalent to immersion operation}
    \end{scnindent}
    \scnitem{scnset}
    \begin{scnindent}
